    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('empresa', models.ForeignKey(blank=True, help_text='Empresa à qual este usuário pertence.', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='usuarios', to='companies.empresa')),
                ...
                ('setor', models.ForeignKey(blank=True, help_text='Setor de atuação do usuário.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='usuarios', to='companies.setor')),
